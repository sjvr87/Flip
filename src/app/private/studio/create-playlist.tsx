...
export default function CreatePlaylistScreen() {
    ...
    const canSubmit = trimmedName.length > 0 && !limitReached && !createMutation.isPending;
    ...
    return (
        <KeyboardAvoidingView
            ...
            <ScrollView contentContainerStyle={tw`pb-10`} keyboardShouldPersistTaps="handled">
                {limitReached ? (
                    <View
                        style={tw`flex-row items-start mx-4 mt-4 p-3 rounded-xl bg-red-50 dark:bg-red-950`}>
                        <Ionicons
                            name="alert-circle"
                            size={18}
                            color="#ef4444"
