 ...
 *
 * jsDelivr serves application/json via an immutable git tag (e.g. @oauth-pin-3;
...
export const OAUTH_CLIENT_METADATA_URL =
    'https://cdn.jsdelivr.net/gh/sjvr87/Flip@oauth-pin-3/assets/oauth-client-metadata.json';
